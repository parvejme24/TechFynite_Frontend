...
export default function BasicInformationCard({
  ...
  console.log("Categories with images:", categories?.filter((cat: any) => cat.imageUrl));
  console.log("Full category data:", categories?.map((cat: any) => ({
    id: cat.id,
    title: cat.title,
                         ...
                         onClick={async () => {
                           ...
                           if (confirm(`Are you sure you want to delete "${categoryName}"? This action cannot be undone.`)) {
                             try {
                               ...
                               await onDeleteCategory(formData.categoryId);
                             } catch (error) {
