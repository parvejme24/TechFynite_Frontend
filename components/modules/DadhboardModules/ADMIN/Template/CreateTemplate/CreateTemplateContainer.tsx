...
const useCreateTemplate = () => {
  return {
    mutateAsync: async (data: FormData) => {
      ...
      console.log("Mock template creation with data:", data);
...
const useCreateTemplateCategory = () => {
  return {
    mutateAsync: async (data: FormData) => {
      // Mock implementation - in real app, this would call your backend API
      console.log("Mock category creation with data:", data);
      return Promise.resolve({ success: true });
    },
    isPending: false,
  };
...
const useUpdateTemplateCategory = () => {
  return {
    mutateAsync: async ({ id, formData }: { id: string; formData: FormData }) => {
      // Mock implementation - in real app, this would call your backend API
      console.log("Mock category update with id:", id, "data:", formData);
      return Promise.resolve({ success: true });
    },
    isPending: false,
  };
...
const useDeleteTemplateCategory = () => {
  return {
    mutateAsync: async (id: string) => {
      // Mock implementation - in real app, this would call your backend API
      console.log("Mock category deletion with id:", id);
      return Promise.resolve({ success: true });
    },
    isPending: false,
  };
