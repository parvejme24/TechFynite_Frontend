    ...
    <Card className="p-2 dark:bg-[#1A1D37]">
      ...
      <CardContent className="p-2 -mt-8">
        <div className="flex items-center justify-between gap-2 mb-2">
          ...
          ></div>
          <div 
            className="h-8 w-8 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse"
      ...
      <CardFooter className="p-2 grid grid-cols-2 gap-2">
        ...
        ></div>
        <div 
          className="h-10 w-16 bg-gray-300 dark:bg-gray-600 rounded animate-pulse ml-auto"
